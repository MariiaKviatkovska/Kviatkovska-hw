...
const Price = function(priseOfGood){
...
const PriceOfGood1 = (priseOfWare1) => {
...
const PriceOfGood2 = (priseOfWare2) => {
...
const season = function (numberOfSeason){
    if(numberOfSeason == 1){
        console.log("winter")
...
function calculationOfExpression (d, f, symbol){
    switch(symbol){
        case "+":
            console.log(d + f)
            break;
...
calculationOfExpression (6, 3, "/")

//8.*  Використовуючи властивості рядків (тип string), та регулярний вираз (regular expression) видалити голосні букви зі слова.

function deletionOfVowels(word){
    let wordNew = word.replace(/[aeiouy]/gi, '');
    return wordNew;
}

console.log(deletionOfVowels("Ababagalamaga"))
...
const metersToKilometers = function(numberOfMeters){
